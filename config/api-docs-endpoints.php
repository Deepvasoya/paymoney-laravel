...
return [
    ...
    api_docs_ep([
        ...
        'path' => 'register',
        'title' => 'Register user',
        'desc' => 'Create account; fields must match UserAuthController validation.',
        'requires_auth' => false,
        'headers' => api_docs_json_public_headers(),
        'parameters' => [
            ['name' => 'first_name', 'in' => 'body', 'type' => 'string', 'required' => true, 'description' => ['en' => 'Given name', 'es' => 'Nombre']],
            ['name' => 'last_name', 'in' => 'body', 'type' => 'string', 'required' => true, 'description' => ['en' => 'Family name', 'es' => 'Apellido']],
        ...
        'request_body' => ['first_name' => 'Jane', 'last_name' => 'Doe', 'email' => 'jane@example.com', 'password' => 'secret'],
        'response_success' => api_docs_std_ok(['success' => true, 'data' => ['token' => '1|…', 'user' => []]]),
    ...
    api_docs_ep([
        ...
        'path' => 'login',
        'title' => 'Login',
        'desc' => 'Authenticate; returns Sanctum API token.',
        'requires_auth' => false,
        'headers' => api_docs_json_public_headers(),
        'parameters' => [
            ['name' => 'email', 'in' => 'body', 'type' => 'string', 'required' => true, 'description' => ['en' => 'Email', 'es' => 'Correo']],
        ...
        'response_success' => api_docs_std_ok(['success' => true, 'data' => ['token' => '2|…', 'user' => []]]),
        'response_error' => ['status' => 401, 'body' => ['success' => false, 'message' => 'Invalid credentials']],
        'status_codes' => [
            ['code' => 200, 'description' => ['en' => 'OK', 'es' => 'Correcto']],
